col_mapper = {
    ...
    15: 'Если я уверен/уверена в своей правоте, я не буду тратить много времени на то, чтобы выслушать аргументы других'
        ' людей.',
    ...
    18: 'Иногда, когда я становлюсь свидетелем ситуации несправедливого отношения к человеку, это не вызывает у меня'
        ' переживаний.',
    ...
    26: 'Когда я читаю интересную книгу, я представляю, какие эмоции я бы испытывал находясь на месте героев этого '
        'произведения.',
    ...
    31: 'У меня был определенный период жизни, когда я получал предупреждения от органов правопорядка, но в последствии'
        ' снова нарушал.',
